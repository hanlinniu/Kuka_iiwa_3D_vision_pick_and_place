    ...
    while (ros::ok())
    {
      ...
      while (ros::ok())
      {
        if (my_iiwa.getRobotIsConnected()) 
        {
          ...
          // iiwa_msgs::JointVelocity desired_velocity;
          // desired_velocity.velocity.a1=0.001;
          // desired_velocity.velocity.a2=0.001;
          // desired_velocity.velocity.a3=0.001;
          // desired_velocity.velocity.a4=0.001;
          // desired_velocity.velocity.a5=0.001;
          // desired_velocity.velocity.a6=0.001;
          // desired_velocity.velocity.a7=0.001;
            ...
            if (my_iiwa.getRobotIsConnected())
              {
                ...
                if (cin.get() == '\n')
                {
                  ...
                  cout<< "Transform finished, please put the workpiece to a new position!"<<endl;
