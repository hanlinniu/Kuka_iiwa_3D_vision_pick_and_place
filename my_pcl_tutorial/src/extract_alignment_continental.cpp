...
main (int argc, char **argv)
{
  ...
  *original_object = *object;
  ...
  align.setMaxCorrespondenceDistance (1.0f * leaf); // Inlier threshold
  ...
  if (align.hasConverged ())
  {
    ...
    tf::Vector3 origin;
    origin.setValue(static_cast<double>(transformation(0,3)),static_cast<double>((1,3)),static_cast<double>(transformation(2,3)));
